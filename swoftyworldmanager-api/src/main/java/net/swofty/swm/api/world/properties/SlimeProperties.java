package net.swofty.swm.api.world.properties;

import net.swofty.swm.api.world.properties.types.SlimePropertyBoolean;
import net.swofty.swm.api.world.properties.types.SlimePropertyInt;
import net.swofty.swm.api.world.properties.types.SlimePropertyString;
