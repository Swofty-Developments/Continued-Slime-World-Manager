package net.swofty.swm.plugin.loaders;
...
import net.swofty.swm.plugin.loaders.file.FileLoader;
import net.swofty.swm.plugin.loaders.mongo.MongoLoader;
import net.swofty.swm.plugin.loaders.mysql.MysqlLoader;
